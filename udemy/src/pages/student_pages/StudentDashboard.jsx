...
//                 </Link>
//               ) : (
//                 // if multiple active windows, show a tiny chooser
...
//                         title={`${new Date(lk.validFrom).toLocaleString()} – ${new Date(
//                           lk.validTo
//                         ).toLocaleString()}`}
//                       >
...
//               <button
//                 disabled
//                 className="px-2.5 sm:px-3 py-1.5 text-xs sm:text-sm rounded-full bg-gray-100 text-gray-400 cursor-not-allowed"
//                 title="No active attendance window right now"
//               >
//                 Mark Attendance
//               </button>
//             )}
