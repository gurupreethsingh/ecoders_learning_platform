...
// // const Blog = () => {
// //   const { id } = useParams(); // expects route: /single-blog/:id
...
// //       const tail = normalized.split("uploads/").pop(); // handle windows paths
...
// //   // Extract ```fenced code``` blocks from body and return { cleanedBody, codeBlocks }
// //   const extractCodeBlocks = (bodyText) => {
// //     if (!bodyText) return { cleanedBody: "", codeBlocks: [] };
// //     const codeBlocks = [];
// //     const regex = /```(?:\w+)?\n([\s\S]*?)```/g; // captures code between fences
...
// //   // Turn remaining body (without code fences) into Q/A sections like your original
...
// //         // Pull fenced code out of body (if any)
...
// //           codeBlocks, // extracted from body fences
...
// //         {section.map((item, i) =>
// //           item.type === "question" ? (
// //             <p key={i} className="font-bold text-lg mb-4 mt-6">
// //               {item.text}
// //             </p>
// //           ) : item.type === "answer" ? (
// //             <blockquote
...
// //             </blockquote>
// //           ) : (
// //             <p key={i} className="text-gray-800 text-lg mb-4">
// //               {item.text}
// //             </p>
// //           )
// //         )}
...
// //   // Renders a gray code block using DIVs, so no <pre> theme can override it
...
// //     // Supports:
// //     // 1) blog.code (optional dedicated field)
// //     // 2) fenced code extracted from body (blog.codeBlocks)
// //     // 3) blog.explanation (optional field)
...
// //       <p className="mb-4">{blog?.category}</p>
...
// //   return (
// //     <motion.div
// //       className="max-w-7xl mx-auto p-4  border-b"
// //       initial={{ opacity: 0 }}
// //       animate={{ opacity: 1 }}
...
// //             <button
// //               onClick={() =>
// //                 prevNext.prev && navigate(`/single-blog/${prevNext.prev._id}`)
// //               }
...
// //             <button
// //               onClick={() =>
// //                 prevNext.next && navigate(`/single-blog/${prevNext.next._id}`)
// //               }
// //               className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg flex items-center shadow disabled:opacity-50"
...
// const Blog = () => {
//   const { id } = useParams(); // route: /single-blog/:id
//   const navigate = useNavigate();
...
//   // DIV-based code block (gray, bulletproof)
//   const CodeBlock = ({ code }) => (
//     <div
//       className="rounded-md overflow-x-auto mb-4"
//       style={{
