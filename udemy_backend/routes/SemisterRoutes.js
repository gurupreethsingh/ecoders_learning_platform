...
router.post(
  "/semisters/bulk/toggle-active",
  SemisterController.bulkToggleActive
);
...
router.get(
  "/semisters/counts/by-academic-year",
  SemisterController.countsByAcademicYear
);
...
router.post(
  "/semisters/bulk/clone-to-degrees",
  SemisterController.cloneToDegrees
);
