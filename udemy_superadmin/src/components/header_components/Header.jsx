...
export default function Header() {
  ...
  return (
    <header>
      {/* Desktop Header */}
      <nav className="shadow-sm" aria-label="Global">
              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg z-10 text-gray-800">
                    <button
                      onClick={goToProfile}
                      className="block w-full text-left px-4 py-2 font-semibold text-sm hover:bg-gray-100 border-b"
                    >
                      Profile
                    </button>
                    <button
                      onClick={handleLogout}
                      className="block w-full text-left px-4 py-2 font-bold text-sm text-red-600 hover:bg-gray-100"
                    >
                      Logout
                    </button>
                  </div>
