...
// //   // Try to extract any related IDs off an instructor object.
// //   // Supports a bunch of likely field names / shapes.
// //   const findRelated = (u) => {
...
// //     // Generic helper for pushing IDs from value(s)
// //     const pushIds = (s, v) => {
// //       asArray(v)
// //         .map(getId)
// //         .filter(Boolean)
...
// //     // Build label+id pairs using the maps
...
// //                           {/* ✅ Associations line (Degree, Category, Subcategory, Course, Semister) */}
...
// //                               {renderPairs(assoc.degrees)}
// //                             </div>

// //                             {/* Categories + Subcategories */}
// //                             <div className="text-xs mt-1">
// //                               <span className="font-medium">Categories: </span>
// //                               {renderPairs(assoc.categories)}
// //                             </div>
// //                             <div className="text-xs mt-1">
// //                               <span className="font-medium">
// //                                 Subcategories:{" "}
// //                               </span>
// //                               {renderPairs(assoc.subcategories)}
// //                             </div>

// //                             {/* Courses */}
// //                             <div className="text-xs mt-1">
// //                               <span className="font-medium">Courses: </span>
// //                               {renderPairs(assoc.courses)}
// //                             </div>

// //                             {/* Semisters */}
// //                             <div className="text-xs mt-1">
// //                               <span className="font-medium">Semisters: </span>
// //                               {renderPairs(assoc.semisters)}
// //                             </div>
// //                           </div>
// //                         </div>
...
//   return (
//     <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 border-b">
//       {/* ===================== LINE 1: Heading + all badges on SAME LINE ===================== */}
...
//       {/* ===================== LINE 2: Search + status dropdown + 3/page dropdown ===================== */}
...
//         {/* Status dropdown (keeps backend-filtered route param) */}
//         <select
//           value={effectiveStatus}
//           onChange={(e) => setStatusInURL(e.target.value)}
//           className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
