...
//         looksLikeObjectId(instData?.semister) ||
...
//           <motion.h3
//             className="subHeadingTextMobile lg:subHeadingText mb-3"
...
//               </code>
//             </span>
//             {typeof inst.applicationStatus === "string" && (
//               <span className="inline-flex items-center gap-2 rounded-full bg-indigo-50 border border-indigo-200 px-3 py-1 text-xs text-indigo-700">
//                 <FaCheck />
...
//           {/* Action buttons */}
//           <div className="mt-3 text-center sm:text-left flex flex-col sm:flex-row gap-3">
//             <Link
