// // src/pages/course_pages/AllCourses.jsx
...
//           subCatRes,
//           semRes,
//           instructorsRes, // optional; if you don't have an endpoint, this will fail silently
...
//             .catch(() => ({ data: { data: [] } })),
//           axios
//             .get(`${globalBackendRoute}/api/users`, {
//               params: { role: "instructor", page: 1, limit: 500 },
//             })
//             .catch(() => ({ data: { data: [] } })),
//         ]);
...
//         }
//       } catch (e) {
//         // silent; UI falls back to IDs if needed
//       }
//     };
