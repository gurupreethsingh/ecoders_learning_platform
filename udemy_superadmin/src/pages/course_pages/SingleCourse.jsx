...
//   const degreeName =
//     (data?.degree && (degreeMap[data.degree] || data?.degree?.name)) || "—";
//   const semName =
//     (data?.semister &&
//       (semMap[data.semister] ||
//         data?.semister?.title ||
//         data?.semister?.semister_name)) ||
//     "—";
//   const catName =
//     (data?.category &&
...
//   const subName =
//     (data?.subCategory &&
//       (subMap[data.subCategory] ||
//         data?.subCategory?.subcategory_name ||
//         data?.subCategory?.name)) ||
//     "—";
//   const instName =
//     (data?.instructor &&
//       (instMap[data.instructor] ||
...
//               <FiUsers /> Instructor
//             </h3>
//             <p className="text-sm text-gray-700">{instName}</p>
//           </div>
//         </div>
...
//               {data.durationInHours ? `${data.durationInHours}h` : "—"}
//             </p>
//           </div>
