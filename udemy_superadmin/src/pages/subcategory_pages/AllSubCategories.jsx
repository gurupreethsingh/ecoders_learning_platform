...
//   const PAGE_SIZE = 12; // adjust if you want more/less per page
...
//       setFilteredSubcategories(filtered);
//     }
//     // reset to first page after category change
//     setCurrentPage(1);
//   };

//   // NEW: clear all selections (show all subcategories)
//   const clearSelection = () => {
//     setSelectedCategory(null);
//     setFilteredSubcategories(subcategories);
//     setSearchQuery(""); // optional: also clear search so you truly see "all"
//     setCurrentPage(1);
//   };
...
//           : updated;
//         setFilteredSubcategories(visible);
//         // after delete, keep page in range
//         setCurrentPage(1);
//       } catch (error) {
//         console.error("Error deleting subcategory:", error);
//         alert("Failed to delete the subcategory.");
...
//   // Search (on top of filteredSubcategories)
//   const searchedSubcategories = filteredSubcategories.filter((sub) => {
//     const subName = (sub.subcategory_name || "").toLowerCase();
//     const categoryId = String(sub.category?._id || sub.category);
//     const categoryObj = categories.find(
...
//   // NEW: Pagination calculations (on the searchedSubcategories)
...
//           }
//         >
//           {(pageItems.length > 0 ? pageItems : []).map((sub) => (
//             <div
//               key={sub._id}
//               className={`relative bg-white rounded-lg p-4 shadow hover:shadow-lg transition ${
//                 view === "list" ? "flex items-center gap-4" : "flex flex-col"
