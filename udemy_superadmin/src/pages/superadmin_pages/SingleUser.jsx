...
// A tiny, always-available fallback image (no external DNS required)
...
const buildImageUrl = (avatar, role) => {
  try {
    if (avatar) {
      // normalize slashes and take just file name to avoid duplicate dirs
      ...
      // If avatar already includes 'uploads/...', allow it too
...
// One-shot error handler to prevent loops + flicker
const handleImageError = (e) => {
  const img = e.currentTarget;
  img.onerror = null; // prevent future loops
...
export default function SingleUser() {
  ...
  const handleRoleUpdate = async () => {
    ...
    try {
      ...
      // If avatar path depends on role folder, rebuild the image URL
