      ...
      <div className="max-w-7xl mx-auto bg-white p-6 md:p-8">
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              View semister information, relations, and associations.
            </p>

            {/* ✅ Semister ID under the header */}
        ...
        <div className="mt-6 rounded-lg border p-4">
          <h2 className="font-semibold text-gray-900 mb-3">Basic</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            {/* ✅ Semister ID inside Basic too */}
            <div className="flex items-center gap-2 text-gray-800">
              <FiHash className="shrink-0" />
              <span className="truncate">
                <span className="font-medium">Semister ID:</span>{" "}
